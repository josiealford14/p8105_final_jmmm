...
```{r load_packages, echo = FALSE, esults = FALSE, warning = FALSE, message = FALSE}
library(tidyverse)
library(tidytext)
...
```{r drug_price_distr, echo = FALSE, warning = FALSE, message = FALSE}
...
```{r price_drug_disease, echo = FALSE, warning = FALSE, message = FALSE}
final_dataset %>% 
...
```{r funding_demand, echo = FALSE, warning = FALSE, message = FALSE}
final_dataset %>% 
...
```{r Disease & Funding, echo = FALSE, warning = FALSE, message = FALSE}
...
```{r Acute vs. Chronic, echo = FALSE, warning = FALSE, message = FALSE}
...
```{r Most Advertised plots, echo = FALSE, warning = FALSE, message = FALSE}
...
```{r Most Popular, echo = FALSE, warning = FALSE, message = FALSE}
final_dataset %>%
  filter(!is.na(avg_price)) %>%
  filter(trade_name %in% most_popular_drugs) %>%
...
```{r Case Study Analysis, echo = FALSE, warning = FALSE, message = FALSE}
final_dataset %>%
  filter(!is.na(avg_price)) %>%
  filter(trade_name %in% most_abused_drugs) %>%
  group_by(trade_name) %>% 
