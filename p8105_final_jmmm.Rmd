...
* Scrapping and Saving the Drug Price  as csv to speed up run-time. The csv cannot be pushed to GitHub, but can obtained from [this link](https://drive.google.com/file/d/1UqALegGpkkAWMhAWgFUiqJZTVLAfb8ci/view?usp=sharing). The drug price was placed in a data folder outside the code repository.
...
#Projection of Expiring Patents
# patents %>%
...
#     mode = 'markers', 
#     marker = list(size = ~num_pat_exp*3), 
#     text = ~paste('Company: ', appfull, 'Disease:', disease)) %>% 
...
# Website: https://josiealford14.github.io/p8105_final_jmmm/
# Shiny repository: https://josiealford14.shinyapps.io/p8105_final_jmmm_shiny/
# GitHub Repo: https://github.com/josiealford14/p8105_final_jmmm.git
```
