...
# Opiods (examine change in prices for opiod drugs. also Percocet is commonly referenced in "trap music". Suboxone is a popular street drug, most popular illicit drug bought and sold in jails and prisons--often smuggled), Depressants (Xanax is frequently referenced in "trap music"), Stimulants (Adderall and Ritalin are commonnly abused by college students)
#Opiod Epidemic (Public Health Threat. data from 2014): 2 million Americans abused or dependent, 1000+ ER visits daily. 78 deaths daily. Practitioners were urged to treat pain aggresively (without the tools and training), pharmaceutical companies marketing prescription opiods to doctors. There were 259 million opiod prescription in 2012, according to the CDC. An increase in 400% since 1999.Prescription opiods account for 1/2 of opiod deaths, heroin (illicit) accounts for other 1/2. Considered gateway drug for heroin. Highly addictive. Other opiods include morphine, codeine cough syrup (know as "lean", "purple drank", "Sizzurp", and "syrup". Infamously, the rapper Lil' Wayne has struggled with past addiction to codeine. The rapper Pimp C died from overdosing on codeine).
...
#One in three unintential overdose deaths result from opiods combined with benzodiazepines (Valium and Xanax)
#https://www.cbsnews.com/news/mixing-opioids-oxycodone-and-popular-sedatives-xanax-may-be-deadly/
```
