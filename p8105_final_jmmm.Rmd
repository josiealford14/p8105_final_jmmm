...
# Xeljanz, which treats both arthritis and rheumatoid arthritis (chronic conditions), has the highest mean average price of $45.70. Eliquis, which treats atrial fibrillation, stroke, and thromboembolism (both chronic and acute conditons), had the lowest mean average price of $5.29 among these drugs.
```
...
# opioids (examine change in prices for opioid drugs. also Percocet is commonly referenced in "trap music". Suboxone is a popular street drug, most popular illicit drug bought and sold in jails and prisons--often smuggled), Depressants (Xanax is frequently referenced in "trap music"), Stimulants (Adderall and Ritalin are commonnly abused by college students)
#opioid Epidemic (Public Health Threat. data from 2014): 2 million Americans abused or dependent, 1000+ ER visits daily. 78 deaths daily. Practitioners were urged to treat pain aggresively (without the tools and training), pharmaceutical companies marketing prescription opioids to doctors. There were 259 million opioid prescription in 2012, according to the CDC. An increase in 400% since 1999.Prescription opioids account for 1/2 of opioid deaths, heroin (illicit) accounts for other 1/2. Considered gateway drug for heroin. Highly addictive. Other opioids include morphine, codeine cough syrup (know as "lean", "purple drank", "Sizzurp", and "syrup". Infamously, the rapper Lil' Wayne has struggled with past addiction to codeine. The rapper Pimp C died from overdosing on codeine).
...
#One in three unintential overdose deaths result from opioids combined with benzodiazepines (Valium and Xanax)
#https://www.cbsnews.com/news/mixing-opioids-oxycodone-and-popular-sedatives-xanax-may-be-deadly/
```

#### Anecdotal or Commonly Discussed in Popular Culture
```{r Popular Culture, warning = FALSE, message = FALSE}
#pharma drugs that people we know use, ones that we see commericals for, and commonly discussed in popular culture
...
# context about the relationship between "pill-pop" and American music
```
