...
patents = patents %>% 
  ...
  #pediatric_exclusivity_granted = 
  #is.na(pediatric_exclusivity_granted) = 0
  #mutate(pediatric_exclusivity_granted = as.character(pediatric_exclusivity_granted)) %>% 
  
  mutate(pediatric_exclusivity_granted = (pediatric_exclusivity_granted[is.na[pediatric_exclusivity_granted] = 0))
  recode(pediatric_exclusivity_granted, "NA" = "no")
  mutate(pediatric_exclusivity_granted = factor(pediatric_exclusivity_granted, levels = c("NA", "PED"), labels = c("No", "Yes")))
  

patents$pediatric_exclusivity_granted[is.na(patents$pediatric_exclusivity_granted)] = "no"

(is.na(patents$pediatric_exclusivity_granted) = TRUE) = "no"
if (patents$pediatric_exclusivity_granted !="PED") {patents$pediatric_exclusivity_granted = 0}
