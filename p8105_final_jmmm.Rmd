...
```
  ...
  + References
    ...
    + https://www.washingtonpost.com/lifestyle/style/soft-smooth-and-steady-how-xanax-turned-american-music-into-pill-pop/2017/04/19/535a44de-1955-11e7-bcc2-7d1a0973e7b2_story.html?utm_term=.49524bcc93b1
...
##### Comparing Mean Average Price per Tablet for each Drug Group
  ...
  + These results are particularly interesting. 
      ...
      + The most abused drugs are relatively inexpensive compared to others. This gives patients greater access to highly addictive prescriptions, including painkillers. This may be a driving force of prescription drug abuse; cheap and highly addicitve are fatal combinations for drug dependence.
...
###### The Distribution of Average Price for Most Popular Drugs
  ...
  + There is no clear trend between disease type (acute vs. chronic) and disease condition (psychiatric drugs vs. cardiovascular).
```{r Most Popular, warning = FALSE, message = FALSE}
x = final_dataset %>%
  filter(!is.na(avg_price)) %>%
  filter(trade_name %in% most_popular_drugs) %>%
  select(trade_name, disease, disease_type) %>% 
...
###### The Distribution of Average Price for Most Abused Drugs 
  + Ambien and Lunesta, which both treat sleep disorders, have the highest median of average drug price per dose of $13.45 and $11.94 respectively. Focalin and Ritalinm, which both treat ADHD, have the lowest median of average drug price per dose of $0.97 each. 
