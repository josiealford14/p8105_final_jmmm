...
What? & Why? (2 sentences)
Summarize (interesting results!, Obesity, cancers)
Case Study (2 sentences): general overview, anything cool. We made shiny app that illustrates the trends. 
2 sentences for MeOak's patent analysis
Limitations: loss data through joining/subsetting (only each/per gram). as a result: affected the graphs and possible Missclassifcication bias of acute vs. chronic. 
we believe that these results help us better understand the factros that go into pricing, 
future work: drug in solution forms and compare. better ways of joining characters without lossing large amounts of data (fuzzy dataset: complex and time consuming, convoluted). 